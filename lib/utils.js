...
// function isSymbollink(pathObj){
// 	//macOs finder make copy not work. important
// 		let isLink = true;
// 		let link = '';
// 		let hasCircle = false;
// 		try{
// 			console.log(pathObj.linkFilePath)
// 			link = fs.lstatSync('Users/admos/Documents/github/node-file/my/softlink/').isSymbolicLink();
// 			console.log(link)
// 		}catch(e){
// 			console.log(link)
// 			console.log(e)
// 			pathObj.linkFilePath = '';
// 			//not link
// 			isLink  =  false;
// 		}
// 		//link
// 		if(isLink){
// 			pathObj.isSoftlink = true;
// 			hasCircle = pathObj.softlinkList.find(function(e){return e === link }) === -1?false:true;
// 			pathObj.linkFilePath = link;
// 			console.log(link)
// 			if(hasCircle)
// 				pathObj.softlinkList.push(link);
// 		}
// 		return pathObj;
// }
